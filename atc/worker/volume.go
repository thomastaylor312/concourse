...
type Volume interface {
	...
	InitializeArtifact(path string, buildID int) (db.WorkerArtifact, error)
...
func (v *volume) InitializeArtifact(path string, buildID int) (db.WorkerArtifact, error) {
	return v.dbVolume.InitializeArtifact(path, buildID)
}
