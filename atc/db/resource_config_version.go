...
type ResourceConfigVersion interface {
	...
	CheckOrder() int
	ResourceVersionOwnership() ResourceVersionOwnership
...
func (r *resourceConfigVersion) ResourceVersionOwnership() ResourceVersionOwnership {
	return r.resourceVersionOwnership
}
