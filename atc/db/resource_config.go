...
type ResourceConfigDescriptor struct {
	...
	customTypeUniqueVersionHistory bool
}
...
func (r *resourceConfig) UniqueVersionHistory() bool                { return r.uniqueVersionHistory }
...
func (r *ResourceConfigDescriptor) findOrCreate(logger lager.Logger, tx Tx, lockFactory lock.LockFactory, conn Conn) (ResourceConfig, error) {
	...
	if r.CreatedByResourceCache != nil {
		...
		rc.uniqueVersionHistory = r.customTypeUniqueVersionHistory
	}
	...
	if r.CreatedByBaseResourceType != nil {
		...
		rc.uniqueVersionHistory = rc.createdByBaseResourceType.UniqueVersionHistory
	}
